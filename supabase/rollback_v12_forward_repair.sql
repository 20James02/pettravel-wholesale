-- =====================================================================
-- PET TRAVEL WHOLESALE — V12 FORWARD REPAIR ROLLBACK SCRIPT
-- =====================================================================
-- Strategy: Deterministic Forward Repair & Safe Rollback
-- Purpose: Restores safe fail-closed accounting while maintaining
--          SECURITY DEFINER hardening and zero-trust ACL perimeter.
-- =====================================================================
...
-- 1. Restore Hardened pt_post_order_accounting
...
BEGIN
  ...
  -- 5. Sale Recognition Posting (Safe Fail-Closed Baseline)
