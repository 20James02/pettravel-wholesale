-- =====================================================================
-- PET TRAVEL WHOLESALE — MIGRATION V11: SECURITY & ACCOUNTING HARDENING
-- =====================================================================
-- Target: Forward reconciliation migration for persistent databases
--         already having received an earlier V10 or historical migrations.
-- Purpose:
--   1. Reconcile and Harden pt_reserve_order_stock:
...
--      - Privilege Normalization: Revoke EXECUTE from PUBLIC, anon, authenticated;
--        Grant EXECUTE conditionally to service_role, pettravel_backend_staging, and pettravel_backend.
--
--   2. Reconcile and Harden pt_post_order_accounting:
...
-- ---------------------------------------------------------------------
-- 3. SECURITY DEFINER PRIVILEGE & ACL NORMALIZATION
-- ---------------------------------------------------------------------
...
-- Grant EXECUTE to service_role if present
do $$
begin
...
-- Grant EXECUTE to dedicated backend roles if present (staging or production)
do $$
begin
